...
function update(arr) {
    ...
    var barchart = g
        .selectAll("rect")
        .data(arr, (d) => d);//by this the each element in data array wil be mapped to its value not to its index. see the normal output and mapped output. the exit fuction output will vary
